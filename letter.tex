...
\def\Who{Qingwei Zhang} % Your name
\def\What{, M.A.Sc} % Your title
\def\Where{Physical Science Division} % Your department/institution
\def\Address{5640 S Ellis Ave} % Your address
\def\CityZip{Chicago, Illinois 60637} % Your city, zip code, country, etc
\def\Email{E-mail: \\ qingwei.zhang@uchicago.edu} % Your email address
\def\TEL{Phone: (646) 617-1626} % Your phone number
\def\URL{} % Your URL
...
\address{
\includegraphics[width=1in]{uchicago.jpg} % Include the logo of your institution
